    ...
    <div className=" py-12 px-4">
      <div className="max-w-[1100px] mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-green-600 mt-3 max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition">
            ...
            <h3 className="font-bold text-red-500 text-lg mb-2">Healthy Animal</h3>
            <p className="text-green-500 text-sm">
              Always choose a healthy and disease-free animal for Qurbani.
            </p>
          </div>

          <div className="bg-gray-800 p-6  text-red-500 rounded-xl shadow hover:shadow-lg transition">
          ...
          <div className="bg-gray-800 text-red-500 p-6 rounded-xl shadow hover:shadow-lg transition">
          ...
          <div className="bg-gray-800 text-red-500 p-6 rounded-xl shadow hover:shadow-lg transition sm:col-span-2 lg:col-span-1">
